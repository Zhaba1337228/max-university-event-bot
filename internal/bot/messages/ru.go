...
func Help() string {
	return joinLines(
		...
		"/help - помощь",
		"/organizer - меню организатора (если у вас есть права)",
		"/admin_login - получить ссылку для входа в веб-админку",
		"/whoami - показать ваш MAX user_id (нужен админу для выдачи доступа)",
