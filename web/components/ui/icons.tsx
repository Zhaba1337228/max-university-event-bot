// Inline SVG icons — no external library, consistent 24×24 viewBox.
// All accept className for sizing/color (e.g. className="w-5 h-5 text-accent").
...
export function IconBroadcast(p: IconProps) {
  return (
    <Icon {...p}>
      ...
      <path d="M10.54 10.54a2 2 0 0 0 0 2.83" />
      <path d="M19.07 4.93a10 10 0 0 1 0 14.14" />
      <path d="M16.24 7.76a6 6 0 0 1 0 8.49" />
      <path d="M13.46 10.54a2 2 0 0 1 0 2.83" />
    </Icon>
  );
}
